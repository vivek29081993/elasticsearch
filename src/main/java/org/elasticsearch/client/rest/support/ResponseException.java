...
public final class ResponseException extends IOException {
    ...
    public ResponseException(RestResponse response) throws IOException {
        super(buildMessage(response));
        this.response = response;
    }

    private static String buildMessage(RestResponse response) throws IOException {
    ...
    /**
     * Returns the {@link RestResponse} that caused this exception to be thrown.
     */
